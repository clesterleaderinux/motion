...
import tfmf.ui.motion.util.MotionUtil.dpToPx
...
class ShimmerBuilder(context: Context) : LinearLayout(context) {
     ...
     * @return The ShimmerBuilder instance.
     */
    fun setElementColor(color: Int): ShimmerBuilder {
        elementColor = ContextCompat.getColor(context, color)
        return this
    }
    ...
    fun setParagraphRowMargin(margin: Int): ShimmerBuilder {
        paragraphRowTopMargin = dpToPx(context, margin).toInt()
        return this
    }
